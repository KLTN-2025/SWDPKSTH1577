...
urlpatterns = [
    ...
    path('requests/<int:pk>/edit/', core_views.edit_request, name='edit_request'),
    path('requests/<int:pk>/delete/', core_views.delete_request, name='delete_request'),
    path('feedback/', core_views.send_feedback, name='send_feedback'),
    ...
    path('admin-dashboard/feedback/', core_views.admin_feedback_management, name='admin_feedback_management'),
    path('admin-dashboard/feedback/<int:pk>/', core_views.process_feedback, name='process_feedback'),
